          ...
          if (isFolder) {
            return (
              <div
                ...
                onMouseEnter={() => setOpenFolderId(item.id)}
              ...
              >
                ...
                {/* Dropdown Category Menu Box */}
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 mt-1.5 w-52 bg-slate-950/95 border border-slate-800 rounded-2xl p-2 shadow-2xl backdrop-blur-2xl z-50 animate-fadeIn space-y-1">
