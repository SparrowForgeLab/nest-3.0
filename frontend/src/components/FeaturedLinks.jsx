        ...
        <div className="flex items-center justify-between px-4 py-2 rounded-xl bg-slate-900/60 border border-slate-800/80 shadow-md backdrop-blur-md">
          ...
          {onOpenEditPinned && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/40 text-amber-300 text-xs font-semibold transition"
            >
        ...
        {items.map((item) => {
          ...
          return (
            <a
              ...
              className="relative flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-900/80 border border-slate-700/60 hover:border-amber-400/60 hover:bg-slate-800 transition-all duration-200 shadow-md group"
            >
